 ...
 * para medir los principales indicadores de sintomas de COVID, los cuales son:
 * Ritmo cardiaco, temperatura y oxigenación en la sangre.
 * Se enviara un JSON por MQTT con todas las variables.
 * Este programa es para el microcontrolador ESP32CAM.
 */
...
//Datos de WiFi
const char* ssid = "Totalplay-2.4G-5fc8";  // Aquí debes poner el nombre de tu red
...
void loop() {
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
    ...
    String json = "{\"id\":\"MiguelP\",\"temp\":"+String(random(18, 23))+",\"hum\":"+String(random (38,52))+"}";
...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (String(topic) == "codigoIoT/detectorSintomas/esp") {  // En caso de recibirse mensaje en el tema esp32/output
    if(messageTemp == "true"){
